...
**Total findings:** 2
**Generated:** 2026-08-18T17:20:38.139147+00:00
...
|---|-----------------|------|------------|---------|-----------|
| 1 | `—` | `hypothesis_promoted` | deterministic_match=True (path-classified, validator-available) — promotion threshold bypassed; score=0.2875 (informational, not gating) | promoted to finding 67def5d9-16f1-428f-a4a7-bfebeadee5d2 | `—` |
| 2 | `—` | `hypothesis_promoted` | deterministic_match=True (path-classified, validator-available) — promotion threshold bypassed; score=0.2250 (informational, not gating) | promoted to finding fdf90161-648c-4526-a00c-7542262faf19 | `—` |
