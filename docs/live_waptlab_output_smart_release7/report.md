...
**Total findings:** 2
**Generated:** 2026-08-18T17:49:47.689996+00:00
...
|---|-----------------|------|------------|---------|-----------|
| 1 | `—` | `hypothesis_promoted` | deterministic_match=True (path-classified, validator-available) — promotion threshold bypassed; score=0.2875 (informational, not gating) | promoted to finding 07d4996e-dda2-40eb-bb9c-6cbd42aacd97 | `—` |
| 2 | `—` | `hypothesis_promoted` | deterministic_match=True (path-classified, validator-available) — promotion threshold bypassed; score=0.2250 (informational, not gating) | promoted to finding 504b2fae-afc0-4c9f-8a33-3f334ce4b8de | `—` |
