...
| Direct-I/O inventory | `docs/direct_io_inventory.json`, 64 records, generated by `scripts/scan_direct_io.py` | verified locally |
...
| 3.2 Central ActionExecutor | All network/browser/socket/subprocess/tool actions pass policy and scope | `src/webpent/shared/campaign_executor.py`; action authority tests; G-02 inventory | partial/strong local | Complete runtime adapter qualification and prove no unauthorized raw I/O in every production path |
