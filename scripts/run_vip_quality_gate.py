...
VIP_FILES = [
    ...
    "src/webpent/knowledge/__init__.py",
    "src/webpent/knowledge/target_knowledge.py",
    "src/webpent/knowledge/builder.py",
    "src/webpent/research/__init__.py",
    "src/webpent/research/hypothesis_engine.py",
    "src/webpent/research/hypothesis_ranker.py",
    "src/webpent/research/experiment_manager.py",
    "src/webpent/validators/__init__.py",
    ...
    "src/webpent/benchmark/__init__.py",
    "src/webpent/benchmark/metrics.py",
    ...
    "tests/test_v62_target_knowledge.py",
    "tests/test_v62_attack_graph_target_knowledge.py",
    "tests/test_v63_hypothesis_engine.py",
    "tests/test_v64_multi_agent_proof_validators.py",
    "tests/test_v65_coverage_copilot_boundary.py",
    "tests/test_v66_benchmark_metrics.py",
    "tests/test_v66_cli_coverage_contract.py",
    "tests/test_v70_release_contracts.py",
]
